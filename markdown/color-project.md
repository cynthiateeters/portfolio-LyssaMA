...
---
title: "Color Project"
description: "An interactive project demonstrating color and interactivity on CodePen."
---

# Color Project

## Project Description
This interactive project showcases dynamic design concepts, focusing on the use of color and animation to create a visually engaging experience.

## Features
- **Dynamic Design**: Uses CSS and JavaScript.
- **Color Interactions**: Highlights how color can influence user interactions.

## Links
- **Live Demo**: [View on CodePen](https://codepen.io/LyssaMA/pen/GRVrVqo)
